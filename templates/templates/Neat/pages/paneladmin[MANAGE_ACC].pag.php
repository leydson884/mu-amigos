<h4 class="heading colr">Gerenciar Conta</h4>
	   <blockquote>
	   <form name="Load_Account" id="Load_Account" class="form">
...
<input type="button" value="Carregar Informa&ccedil;&otilde;es" onclick="CTM_Load('?pag=paneladmin&str=EDIT_ACC','Show_Options','POST',BuscaElementosForm('Load_Account'));" class="btnform">
</form>
	</blockquote>
