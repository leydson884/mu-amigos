...
<form name="New_Nick" id="New_Nick" class="form">
...
<input type="button" value="Alterar Nick" onclick="CTM_Load('?pag=paneluser&str=CHANGE_NICK&cmd=true','Command','POST',BuscaElementosForm('New_Nick'));" class="btnform">
	  </form>
	</blockquote>
	<div id="Command"></div>