	   <blockquote>
	   <form name="Manage_Account" id="Manage_Account" class="form">
...
<input type="button" value="Editar Conta" onclick="CTM_Load('?pag=paneladmin&str=EDIT_ACC&cmd=true&id={%ACCOUNT_VALUE%}','Command','POST',BuscaElementosForm('Manage_Account'));" class="btnform">
</form>
	</blockquote>
	<div id="Command"></div>