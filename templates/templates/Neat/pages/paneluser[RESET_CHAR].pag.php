...
<br /><b class="colr">Deseja Resetar seu personagem?</b><Br /><br /><input type="button" value="Resetar Personagem" onclick="CTM_Load('?pag=paneluser&str=RESET_CHAR&cmd=true','Command','GET');" class="btnform">
</blockquote>
<div id="Command"></div>