<h4 class="heading colr">Adicionar CronTab</h4>
	   <blockquote>
	   <form name="Add_CronTab" id="Add_CronTab" class="form">
				...
				<input type="button" value="Adicionar CronTab" onClick="CTM_Load('?pag=paneladmin&str=ADD_CRONTAB&cmd=true','Command','POST',BuscaElementosForm('Add_CronTab'));" class="btnform">
				</form>
