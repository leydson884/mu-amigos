<h4 class="heading colr">Transformar VIP</h4>
	   <blockquote>
	   <form name="Transform_VIP" id="Transform_VIP" class="form">
...
<input type="button" value="Transformar VIP" onclick="CTM_Load('?pag=paneladmin&str=TRANSFORM_VIP&cmd=true','Command','POST',BuscaElementosForm('Transform_VIP'));" class="btnform">
</form>
	</blockquote>
	<div id="Command"></div>