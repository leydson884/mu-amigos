<h4 class="heading colr">Efetuar Backups</h4>
	<blockquote>
<form name="SQL_Backup" id="SQL_Backup" class="form">
<table width="305" border="0">
  ...
  <tr>
    ...
    <td><input type="text" name="Directory" id="Directory" value="C:/Backups/" /></td></td>
      ...
      <tr>
        <td align="center" colspan="41"><input type="button" value="Efetuar aBackup" onclick="CTM_Load('?pag=paneladmin&str=SQL_BACKUP&cmd=true','Command','POST',BuscaElementosForm('SQL_Backup'));" class="btnform"></td>
      </tr>
</table>
</form>
</blockquote>
