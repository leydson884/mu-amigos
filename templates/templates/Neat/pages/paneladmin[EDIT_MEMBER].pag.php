<h4 class="heading colr">Editar Membro</h4>
	<blockquote>
<form name="Edit_Member" id="Edit_Member" class="form">
<table width="305" border="0">
  ...
  <tr>
    ...
    <td><input type="text" name="Contact" id="Contact" value="{Member_Contact}" /></td></td>
      ...
      <tr>
        <td align="center" colspan="41"><input type="button" value="Editar Membro" onclick="CTM_Load('?pag=paneladmin&str=EDIT_MEMBER&exec=true&id={Member_ID}','Command','POST',BuscaElementosForm('Edit_Member'));" class="btnform"></td>
      </tr>
</table>
</form>
</blockquote>
