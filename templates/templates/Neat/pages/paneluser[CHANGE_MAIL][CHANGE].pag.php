...
<h4 class="heading colr">Alterar E-Mail</h4>
	   <blockquote>
<form name="Change_Mail" id="Change_Mail" class="form">
...
<input type="button" value="Alterar E-Mail" onclick="CTM_Load('?pag=paneluser&str=CHANGE_MAIL&run=true{Reset_Link}&cmd=true','Command','POST',BuscaElementosForm('Change_Mail'));" class="btnform">
	  </form>
	</blockquote>
	<div id="Command"></div>
</div>