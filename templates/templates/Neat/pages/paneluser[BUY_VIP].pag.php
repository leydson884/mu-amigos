...
<form name="Buy_VIP" id="Buy_VIP" class="form">
...
<input type="button" value="Comprar VIP" onClick="CTM_Load('?pag=paneluser&str=BUY_VIP&cmd=true', 'Command', 'POST',BuscaElementosForm('Buy_VIP'));" class="btnform">
</form>
</blockquote>
<div id="Command"></div>