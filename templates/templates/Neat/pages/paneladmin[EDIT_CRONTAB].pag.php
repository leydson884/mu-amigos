<h4 class="heading colr">Editar CronTab</h4>
	   <blockquote>
	   <form name="Edit_CronTab" id="Edit_CronTab" class="form">
				...
				<input type="button" value="Editar CronTab" onClick="CTM_Load('?pag=paneladmin&str=EDIT_CRONTAB&cmd=true&id={CronTab_ID}','Command','POST',BuscaElementosForm('Edit_CronTab'));" class="btnform">
				</form>
