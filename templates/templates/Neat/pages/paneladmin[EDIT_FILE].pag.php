<h4 class="heading colr">Editar arquivo</h4>
	   <blockquote>
	   <form name="Edit_File" id="Edit_File" class="form">
...
<input type="button" value="Editar Arquivo" onclick="CTM_Load('?pag=paneladmin&str=EDIT_FILE&exec=true&id={File_ID}','Command','POST',BuscaElementosForm('Edit_File'));"  class="btnform">
</form>
	</blockquote>
	<div id="Command"></div>