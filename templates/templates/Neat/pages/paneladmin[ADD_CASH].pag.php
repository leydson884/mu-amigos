<h4 class="heading colr">Adicionar Moeda</h4>
	   <blockquote>
	   <form name="Add_Cash" id="Add_Cash" class="form">
...
<input type="button" value="Adicionar Moeda" onclick="CTM_Load('?pag=paneladmin&str=ADD_CASH&cmd=true','Command','POST',BuscaElementosForm('Add_Cash'));" class="btnform">
</form>
	</blockquote>
	<div id="Command"></div>