<h4 class="heading colr">Adicionar Noticia</h4>
	<blockquote>
<form name="Add_News" id="Add_News" class="form">
<table width="305" border="0">
  ...
  <tr>
    ...
    <td><input type="checkbox" name="Comments_Enable" id="Comments_Enable" checked="checked" /></td>
      ...
      <tr>
        <td align="center" colspan="41"><textarea name="Text" id="Text" cols="35" rows="7"></textarea><br />&nbsp;</td>
      </tr>
      <tr>
        <td align="center" colspan="41"><input type="button" value="Adicionar Noticia" onclick="CTM_Load('?pag=paneladmin&str=ADD_NEWS&cmd=true','Command','POST',BuscaElementosForm('Add_News'));" class="btnform"></td>
      </tr>
</table>
</form>
</blockquote>
