...
<br />
<form name="Transfer_Resets" id="Transfer_Resets" class="form">
...
<input type="button" value="Transferir" onClick="CTM_Load('?pag=paneluser&str=TRANSFER_RESETS&cmd=true', 'Command', 'POST',BuscaElementosForm('Transfer_Resets'));" class="btnform">
</form>
</blockquote>
<div id="Command"></div>