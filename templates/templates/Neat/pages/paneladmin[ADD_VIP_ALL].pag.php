<h4 class="heading colr">Adicionar VIP em todas as Contas</h4>
	   <blockquote>
	   <form name="Add_VIP" id="Add_VIP" class="form">
...
<br />
<input type="button" value="Adicionar VIP" onclick="CTM_Load('?pag=paneladmin&str=ADD_VIP_ALL&cmd=true','Command','POST',BuscaElementosForm('Add_VIP'));" class="btnform">
</form>
	</blockquote>
	<div id="Command"></div>