<h4 class="heading colr">Adicionar Membro</h4>
	<blockquote>
<form name="Add_Member" id="Add_Member" class="form">
<table width="305" border="0">
  ...
  <tr>
    ...
    <td><input type="text" name="Contact" id="Contact" /></td></td>
      ...
      <tr>
        <td align="center" colspan="41"><input type="button" value="Adicionar Membro" onclick="CTM_Load('?pag=paneladmin&str=ADD_MEMBER&cmd=true','Command','POST',BuscaElementosForm('Add_Member'));" class="btnform"></td>
      </tr>
</table>
</form>
</blockquote>
