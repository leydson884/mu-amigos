<h4 class="heading colr">Pagamentos</h4>
  ...
  <div class="TabbedPanelsContentGroup">
	...
	<div class="TabbedPanelsContent">
	<form name="Confirm_Paymet" id="Confirm_Payment" class="form">
  ...
  <tr align="center">
      ...
      <tr>
        <td align="center" colspan="33"><input type="button" value="Confirmar Pagamento" onclick="CTM_Load('?pag=paneluser&str=PAYMENTS&exec=true','Command','POST',BuscaElementosForm('Confirm_Payment'));" class="btnform"></td>
      </tr>
  </table>
  </form>
    </div>
