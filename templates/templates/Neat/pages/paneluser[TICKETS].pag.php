...
<table width="305" border="0">
  ...
  <tr>
    ...
    {Character_List}
      ...
      <tr>
        <td align="center" colspan="41"><input type="button" value="Abrir Ticket" onclick="CTM_Load('?pag=paneluser&str=TICKETS&cmd=true','Command','POST',BuscaElementosForm('Open_Ticket'));" class="btnform"></td>
      </tr>
</table>
</form>
</div>
