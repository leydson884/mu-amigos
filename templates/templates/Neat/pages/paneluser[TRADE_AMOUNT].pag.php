...
<? } ?>
<br />
<form name="Trade_Amount" id="Trade_Amount" class="form">
...
<input type="button" value="Trocar" onClick="CTM_Load('?pag=paneluser&str=TRADE_AMOUNT&cmd=true', 'Command', 'POST',BuscaElementosForm('Trade_Amount'));" class="btnform">
</form>
</blockquote>
<div id="Command"></div>