<h4 class="heading colr">Distribuir Pontos</h4>
	   ...
	   <b class="colr">Distribua seus Pontos</b><Br /><br />
        <form name="Distribute_Points" id="Distribute_Points" class="form">
...
<input type="button" value="Distribuir Pontos" onClick="CTM_Load('?pag=paneluser&str=DISTRIBUTE_POINTS&cmd=true','Command','POST',BuscaElementosForm('Distribute_Points'));" class="btnform">
</form>
	</blockquote>
	<div id="Command"></div>