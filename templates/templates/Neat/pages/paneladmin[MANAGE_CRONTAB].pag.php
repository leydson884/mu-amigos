...
<h4 class="heading colr">Gerenciar CronTabs</h4>
	   <blockquote>
       <form name="Manage_CronTab" id="Manage_CronTab" class="form">
		   <strong>Noticia:</strong> <select name="Id" id="Id">
           {CronTab_List}
           </select>&nbsp;<input type="button" value="Editar" onclick="CTM_Load('?pag=paneladmin&str=EDIT_CRONTAB','While','POST',BuscaElementosForm('Manage_CronTab'));" class="btnform">
           <input type="button" value="Deletar CronTab" onclick="Delete_CronTab()" class="btnform">
		   </form>
	</blockquote>
	<div id="While"></div>