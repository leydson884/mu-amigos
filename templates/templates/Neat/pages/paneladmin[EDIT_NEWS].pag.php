<h4 class="heading colr">Editar Noticia</h4>
	<blockquote>
<form name="Edit_News" id="Edit_News" class="form">
<table width="305" border="0">
  ...
  <tr>
    ...
    <td><input type="checkbox" name="Comments_Enable" id="Comments_Enable" {Notice_Comments} /></td>
      ...
      <tr>
        <td align="center" colspan="41"><textarea name="Text" id="Text" cols="35" rows="7">{Notice_Text}</textarea><br /></td>
      </tr>
      <tr>
        <td align="center" colspan="41"><input type="button" value="Editar Noticia" onclick="CTM_Load('?pag=paneladmin&str=EDIT_NEWS&exec=true&id={Notice_ID}','Command','POST',BuscaElementosForm('Edit_News'));" class="btnform"></td>
      </tr>
</table>
</form>
</blockquote>
