...
O PagSeguro &eacute; o meio de pagamento mais completo e eficiente na prote&ccedil;&atilde;o contra fraudes em compras online.<br /><br />
            ...
            <br />
            <form  action="https://pagseguro.uol.com.br/security/webpagamentos/webpagto.aspx" class="form" method="post" target="_blank" id="pagse" name="pagse">
            ...
            &nbsp;&nbsp;&raquo; Preencha o formulario abaixo:
                    <table width="305" border="0" cellpadding="2">
              <tr>
              ...
              <tr>
                ...
                onclick="retirar('item_valor_1')" type="submit" id="contribuir" value="Efetuar Pagamento" class="btnform"></td>
              </tr>
                    </table>
                </form>
</blockquote>