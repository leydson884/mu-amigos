	   <blockquote>
	   <form name="Add_Poll" id="Add_Poll" class="form">
...
<input type="button" value="Adicionar Enquete" onclick="CTM_Load('?pag=paneladmin&str=ADD_POLL&cmd=true&num={%Numbers%}','Command','POST',BuscaElementosForm('Add_Poll'));" class="btnform">
</form>
	</blockquote>
	<div id="Command"></div>