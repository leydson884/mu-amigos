<h4 class="heading colr">Limpar Personagem</h4>
	   <blockquote>
		...
		<form name="Clear_Char" id="Clear_Char" class="form">
  ...
  <tr>
    ...
    <td><input type="checkbox" name="Quests" id="Quests" /></td>
		...
		<input type="button" value="Executar Comando" onclick="CTM_Load('?pag=paneluser&str=CLEAR_CHAR&cmd=true','Command','POST',BuscaElementosForm('Clear_Char'));" class="btnform">
		</form>
	</blockquote>
	<div id="Command"></div>