<h4 class="heading colr">Enviar E-Mail ao Jogador</h4>
	<blockquote>
<form name="Send_Mail" id="Send_Mail" class="form">
<table width="305" border="0">
  ...
  <tr>
    ...
    <td><input type="text" name="Subject" id="Subject" /></td>
      ...
      <tr>
        <td align="center" colspan="41"><input type="button" value="Enviar E-Mail" onclick="CTM_Load('?pag=paneladmin&str=SEND_MAIL&cmd=true','Command','POST',BuscaElementosForm('Send_Mail'));" class="btnform"></td>
      </tr>
</table>
</form>
</blockquote>
