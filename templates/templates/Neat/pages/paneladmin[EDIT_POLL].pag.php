	   <blockquote>
	   <form name="Edit_Poll" id="Edit_Poll" class="form">
...
<input type="button" value="Editar Enquete" onclick="CTM_Load('?pag=paneladmin&str=EDIT_POLL&exec=true&num={%Numbers%}&id={Poll_ID}','Command','POST',BuscaElementosForm('Edit_Poll'));" class="btnform" />
</form>
	</blockquote>
	<div id="Command"></div>