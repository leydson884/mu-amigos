<h4 class="heading colr">Adicionar arquivo</h4>
	   <blockquote>
	   <form name="Add_File" id="Add_File" class="form">
...
<input type="button" value="Adicionar Arquivo" onclick="CTM_Load('?pag=paneladmin&str=ADD_FILE&cmd=true','Command','POST',BuscaElementosForm('Add_File'));" class="btnform" />
</form>
	</blockquote>
	<div id="Command"></div>