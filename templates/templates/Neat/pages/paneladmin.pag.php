...
<div class="header-section">Painel Administrativo</div>
	<table width="100%" border="0" cellspacing="0" cellpadding="0" id="panelfix">
  <tr>
...
<? } ?>
       ...
       <td align="left" valign="top" bgcolor="#F0F0F0" id="Panel_Nav">
	   	{Panel_Navigator}
	   </td>
  </tr>
</table>
