<h4 class="heading colr">Criar Personagem</h4>
	   <blockquote>
	   <form name="Create_Character" id="Create_Character" class="form">
...
<input type="button" value="Criar Char" onclick="CTM_Load('?pag=paneladmin&str=CREATE_CHAR&cmd=true','Command','POST',BuscaElementosForm('Create_Character'));" class="btnform">
</form>
	</blockquote>
	<div id="Command"></div>