...
<table width="305" border="0">
  <tr>
    ...
    <td width="147"><input type="text" name="Name" id="Name" value="{Account_Name}" /></td>
  </tr>
  <tr>
    <td>E-Mail:</td>
...
<input type="button" value="Editar Dados" onclick="CTM_Load('?pag=paneluser&str=ACCOUNT&cmd=account','Command','POST',BuscaElementosForm('Account_Dates'));" class="btnform">
</form>
</blockquote>
<h4 class="heading colr">Alterar Senha</h4>
<blockquote>
            	<form name="Account_Pwd" id="Account_Pwd" class="form">
<table width="305" border="0">
  <tr>
    <td>Senha Atual:</td>
  ...
  <tr>
    <td width="148">Nova Senha:</td>
    <td width="147"><input type="password" name="Password" id="Password" maxlength="10" onKeyUp="PasswordLevel('Password');" /><span id="PasswordResult"></span></td>
  </tr>
  <tr>
...
<input type="button" value="Alterar Senha" onclick="CTM_Load('?pag=paneluser&str=ACCOUNT&cmd=password','Command','POST',BuscaElementosForm('Account_Pwd'));" class="btnform">
</form>
</blockquote>
<div id="Command"></div>
