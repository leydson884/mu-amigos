<h4 class="heading colr">Sortear Jogador</h4>
	   <blockquote>
<form name="Raffle_Player" id="Raffle_Player" class="form">
...
<br />
<input type="button" value="Sortear Jogador" onclick="CTM_Load('?pag=paneladmin&str=RAFFLE_PLAYER&cmd=true','Command','POST',BuscaElementosForm('Raffle_Player'));" class="btnform">
</form>
	</blockquote>
	<div id="Command"></div>